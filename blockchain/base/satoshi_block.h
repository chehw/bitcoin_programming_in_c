...
enum BLOCK_PARSER_ERROR
{
	BLOCK_PARSER_ERROR_INVALID_PARAMETERS = -1,
	BLOCK_PARSER_ERROR_SUCCESS = 0,
	BLOCK_PARSER_ERROR_NEED_DATA = 1,
	BLOCK_PARSER_ERROR_INVALID_LENGTH = 2,
	BLOCK_PARSER_ERROR_INVALID_BLOCK_FORMAT = 4,
	BLOCK_PARSER_ERROR_INVALID_TXN_COUNT = 8,
	BLOCK_PARSER_ERROR_INVALID_TX_FORMAT = 16
};
...
const unsigned char * block_parser_attach(block_parser_t * bp, const unsigned char * p_block, uint32_t length);
